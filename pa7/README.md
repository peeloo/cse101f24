...
This project implements a Dictionary Abstract Data Type in C++ using a Binary Search Tree. The main components include the main file Order.cpp, a Dictionary ADT to store keys and values, and a test file to validate the functionality of the Dictionary.
